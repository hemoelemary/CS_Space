...
Revision ID: b108b00d552d
Revises: e7ef5cbb4024
Create Date: 2026-04-17 06:00:58.611144
...
revision = 'b108b00d552d'
down_revision = 'e7ef5cbb4024'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_user_follower_id'))
...
def downgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_user_follower_id'), ['follower_id'], unique=False)
